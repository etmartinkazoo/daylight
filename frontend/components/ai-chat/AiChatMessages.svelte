...
<style>
  ...
  .ai-empty-title { font-size: 1rem; font-weight: 600; color: var(--color-fg, #0f172a); }
  .ai-empty-hint { font-size: 0.8125rem; }
  .ai-empty-hint :global(kbd) {
    padding: 0.0625rem 0.25rem; border-radius: 0.1875rem;
    background: var(--color-accent, #f1f5f9); border: 1px solid var(--color-border, rgba(226, 232, 240, 0.6));
    font-family: inherit; font-size: 0.75rem; font-weight: 600;
  }
  .ai-shortcuts {
    margin-top: 0.5rem; display: flex; align-items: center; gap: 0.125rem; font-size: 0.6875rem;
    kbd { padding: 0.0625rem 0.3125rem; border-radius: 0.375rem; background: var(--color-accent, #f1f5f9); border: 1px solid var(--color-border, rgba(226, 232, 240, 0.6)); font-family: inherit; font-size: 0.625rem; }
  }
  ...
  .msg-avatar {
    ...
    background: var(--color-accent, #f1f5f9); color: var(--color-fg, #0f172a);
    svg { width: 1rem; height: 1rem; }
  }
  .msg-body { flex: 1; min-width: 0; }
  .msg-role { display: block; font-size: 0.75rem; font-weight: 600; color: var(--color-fg, #0f172a); margin-bottom: 0.25rem; }
  .msg-content {
    font-size: 0.8125rem; line-height: 1.65; color: var(--color-fg, #0f172a);
    overflow-wrap: break-word; word-break: break-word;
  }

  .cursor-blink {
    display: inline-block; width: 2px; height: 0.875rem;
    background: var(--color-primary, #4f46e5); margin-left: 2px;
  ...
  .dot {
    width: 5px; height: 5px; border-radius: 50%; background: var(--color-muted, #64748b);
  ...
  .tool-status {
    ...
    font-size: 0.8125rem; color: var(--color-muted, #64748b); font-style: italic;
  }
  .tool-spinner {
    width: 14px; height: 14px;
    border: 2px solid var(--color-border, rgba(226, 232, 240, 0.6)); border-top-color: var(--color-primary, #4f46e5);
  ...
  .see-thinking-btn {
    ...
    color: var(--color-primary, #4f46e5); background: none;
    border: 1px solid var(--color-primary, #4f46e5); border-radius: 9999px;
    padding: 0.125rem 0.5rem; cursor: pointer; white-space: nowrap;
    &:hover { background: var(--color-primary-subtle, #eef2ff); }
  }

  .thinking-log {
    margin-top: 0.5rem; padding: 0.5rem 0.75rem;
    background: var(--color-surface, #f8fafc); border: 1px solid var(--color-border, rgba(226, 232, 240, 0.6));
    border-radius: 0.375rem; font-size: 0.75rem;
    max-height: 12rem; overflow-y: auto;
  }
  .thinking-log-title {
    font-size: 0.625rem; font-weight: 600; text-transform: uppercase;
    letter-spacing: 0.04em; color: var(--color-muted, #64748b); margin-bottom: 0.25rem;
  }
  .thinking-log-entry {
    display: flex; align-items: baseline; gap: 0.5rem;
    padding: 0.1875rem 0; border-bottom: 1px solid var(--color-border, rgba(226, 232, 240, 0.6));
    &:last-child { border-bottom: none; }
  }
  .thinking-log-tool { font-family: monospace; font-size: 0.6875rem; font-weight: 600; color: var(--color-primary, #4f46e5); flex-shrink: 0; }
  .thinking-log-msg { color: var(--color-fg, #0f172a); font-size: 0.75rem; }
  ...
  .ai-stop-bar {
    ...
    padding: 0.5rem 1rem; border-top: 1px solid var(--color-border, rgba(226, 232, 240, 0.6)); flex-shrink: 0;
  }
  .ai-stop-btn {
    display: flex; align-items: center; gap: 0.375rem;
    padding: 0.375rem 0.75rem; font-size: 0.75rem; font-weight: 500;
    font-family: inherit; border: 1px solid var(--color-border, rgba(226, 232, 240, 0.6));
    border-radius: 9999px; background: var(--color-bg, #fff);
    color: var(--color-fg, #0f172a); cursor: pointer; transition: all 0.1s;
    &:hover { background: var(--color-danger-subtle, #fef2f2); border-color: var(--color-danger, #dc2626); color: var(--color-danger, #dc2626); }
  }
</style>
