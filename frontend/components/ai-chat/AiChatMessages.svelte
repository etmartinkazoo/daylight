...
<style>
  ...
  .ai-empty-hint :global(kbd) {
    padding: 0.0625rem 0.25rem; border-radius: calc(var(--radius-sm) * 0.5);
  ...
  .ai-shortcuts {
    ...
    kbd { padding: 0.0625rem 0.3125rem; border-radius: var(--radius-sm); background: var(--color-accent); border: 1px solid var(--color-border); font-family: inherit; font-size: 0.625rem; }
  }
